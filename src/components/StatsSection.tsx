...
function StatCard({
  ...
  return (
    ...
    >
      ...
      <div className="font-body text-beige/60 text-sm uppercase tracking-widest">
        {stat.label}
      </div>
    </div>
  );
...
export default function StatsSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-8 -left-8 w-48 h-48 hex-clip bg-gold/5" aria-hidden="true" />
      <div className="absolute -bottom-8 -right-8 w-48 h-48 hex-clip bg-gold/5" aria-hidden="true" />

      <div className="relative z-10 max-w-7xl! mx-auto! p-4! sm:p-6! lg:p-8!">
        <h2
          id="stats-heading"
          className={`font-display font-700 text-center text-beige/40 text-xs tracking-widest uppercase mb-10! transition-all duration-700 ${

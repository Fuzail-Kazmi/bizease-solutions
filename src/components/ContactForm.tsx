  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full py-4 px-8 font-display font-700 text-base bg-[var(--color-green-dark)] text-[var(--color-beige)] rounded-xl hover:bg-[var(--color-green-mid)] hover:shadow-xl hover:shadow-[var(--color-green-dark)]/30 hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-3"
        aria-live="polite"
      >
        {status === "loading" ? (
          <>
